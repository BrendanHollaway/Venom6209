...
public class Threaded_Arm extends BufferSupportedRunnable {
    ...
    public void run() {
        while (true) // perfectly valid to put infinite loop here or can run linear
        {
            ...
            armServo.setPosition(clawControl);
